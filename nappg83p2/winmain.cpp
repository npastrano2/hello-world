/*
	...
	GAME 2330 - 001
	PG 83 P 2
	I had issues with the fullscreen code, this one worked, I changed it to full screen and the resolution.
*/
...
void Game_Run(HWND hwnd)
{
    ...
    d3ddev->Clear(0, NULL, D3DCLEAR_TARGET, D3DCOLOR_XRGB(255,255,0), 1.0f, 0);
...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpCmdLine, int nCmdShow)
{
    ...
    HWND window = CreateWindow( APPTITLE.c_str(), APPTITLE.c_str(),
       WS_EX_TOPMOST | WS_VISIBLE | WS_POPUP,//WS_OVERLAPPEDWINDOW,
